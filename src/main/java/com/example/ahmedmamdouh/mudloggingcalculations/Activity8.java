...
public class Activity8 extends android.support.v7.app.AppCompatActivity    {
...
public void onCreate(android.os.Bundle savedInstanceState) {
    ...
    setContentView(com.example.ahmedmamdouh.mudloggingcalculations.R.layout.layout8);
...
public void calculate(){
    ...
    //do the calculation
    Double calculatedValue = (41.17*value1);
