 ...
 */
public class Activity7 extends android.support.v7.app.AppCompatActivity    {
...
public void onCreate(android.os.Bundle savedInstanceState) {
    ...
    setContentView(com.example.ahmedmamdouh.mudloggingcalculations.R.layout.layout7);
...
public void calculate(){
    ...
    //do the calculation
    Double calculatedValue = (30.48*value1);
