...
public class Activity25 extends android.support.v7.app.AppCompatActivity    {
...
public void onCreate(android.os.Bundle savedInstanceState) {
    ...
    setContentView(com.example.ahmedmamdouh.mudloggingcalculations.R.layout.layout25);
...
public void calculate(){
    ...
    //do the calculation
    Double calculatedValue = (6.61*value1);
