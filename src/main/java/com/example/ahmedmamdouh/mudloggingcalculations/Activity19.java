...
public class Activity19 extends android.support.v7.app.AppCompatActivity    {
...
public void onCreate(android.os.Bundle savedInstanceState) {
    ...
    setContentView(com.example.ahmedmamdouh.mudloggingcalculations.R.layout.layout19);
...
public void calculate(){
    ...
    //do the calculation
    Double calculatedValue = (19.79*value1);
