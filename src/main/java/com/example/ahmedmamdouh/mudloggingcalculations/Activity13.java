...
public class Activity13 extends android.support.v7.app.AppCompatActivity    {
...
public void onCreate(android.os.Bundle savedInstanceState) {
    ...
    setContentView(com.example.ahmedmamdouh.mudloggingcalculations.R.layout.layout13);
...
public void calculate(){
    ...
    //do the calculation
    Double calculatedValue = (4.15*value1);
