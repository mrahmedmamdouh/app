...
public class Activity24 extends android.support.v7.app.AppCompatActivity    {
...
public void onCreate(android.os.Bundle savedInstanceState) {
    ...
    setContentView(com.example.ahmedmamdouh.mudloggingcalculations.R.layout.layout24);
...
public void calculate(){
    ...
    //do the calculation
    Double calculatedValue = (12.23*value1);
