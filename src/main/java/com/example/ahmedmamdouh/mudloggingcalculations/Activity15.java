...
public class Activity15 extends android.support.v7.app.AppCompatActivity    {
...
public void onCreate(android.os.Bundle savedInstanceState) {
    ...
    setContentView(com.example.ahmedmamdouh.mudloggingcalculations.R.layout.layout15);
...
public void calculate(){
    ...
    //do the calculation
    Double calculatedValue = (2.79*value1);
