...
public class Activity23 extends android.support.v7.app.AppCompatActivity    {
...
public void onCreate(android.os.Bundle savedInstanceState) {
    ...
    setContentView(com.example.ahmedmamdouh.mudloggingcalculations.R.layout.layout23);
...
public void calculate(){
    ...
    //do the calculation
    Double calculatedValue = (13.20*value1);
