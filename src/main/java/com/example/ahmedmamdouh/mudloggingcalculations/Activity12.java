...
public class Activity12 extends android.support.v7.app.AppCompatActivity    {
...
public void onCreate(android.os.Bundle savedInstanceState) {
    ...
    setContentView(com.example.ahmedmamdouh.mudloggingcalculations.R.layout.layout12);
...
public void calculate(){
    ...
    //do the calculation
    Double calculatedValue = (4.81*value1);
