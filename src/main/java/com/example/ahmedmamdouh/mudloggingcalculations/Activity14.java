...
public class Activity14 extends android.support.v7.app.AppCompatActivity    {
...
public void onCreate(android.os.Bundle savedInstanceState) {
    ...
    setContentView(com.example.ahmedmamdouh.mudloggingcalculations.R.layout.layout14);
...
public void calculate(){
    ...
    //do the calculation
    Double calculatedValue = (5.36*value1);
