...
public class Activity20 extends android.support.v7.app.AppCompatActivity    {
...
public void onCreate(android.os.Bundle savedInstanceState) {
    ...
    setContentView(com.example.ahmedmamdouh.mudloggingcalculations.R.layout.layout20);
...
public void calculate(){
    ...
    //do the calculation
    Double calculatedValue = (13.97*value1);
