...
/**
 * Created by Ahmed Mamdouh on 14/09/2016.
 */

public class Activity11 extends android.support.v7.app.AppCompatActivity    {
...
public void onCreate(android.os.Bundle savedInstanceState) {
    ...
    setContentView(com.example.ahmedmamdouh.mudloggingcalculations.R.layout.layout11);
...
public void calculate(){
    ...
    //do the calculation
    Double calculatedValue = (8.87*value1);
