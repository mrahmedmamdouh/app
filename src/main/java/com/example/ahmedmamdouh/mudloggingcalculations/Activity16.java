...
public class Activity16 extends android.support.v7.app.AppCompatActivity    {
...
public void onCreate(android.os.Bundle savedInstanceState) {
    ...
    setContentView(com.example.ahmedmamdouh.mudloggingcalculations.R.layout.layout16);
...
public void calculate(){
    ...
    //do the calculation
    Double calculatedValue = (3.23*value1);
