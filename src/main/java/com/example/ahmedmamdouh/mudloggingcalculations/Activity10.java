...
public class Activity10 extends android.support.v7.app.AppCompatActivity    {
...
public void onCreate(android.os.Bundle savedInstanceState) {
    ...
    setContentView(com.example.ahmedmamdouh.mudloggingcalculations.R.layout.layout10);
...
public void calculate(){
    ...
    //do the calculation
    Double calculatedValue = (9.36*value1);
