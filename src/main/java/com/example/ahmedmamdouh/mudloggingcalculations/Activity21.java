...
public class Activity21 extends android.support.v7.app.AppCompatActivity    {
...
public void onCreate(android.os.Bundle savedInstanceState) {
    ...
    setContentView(com.example.ahmedmamdouh.mudloggingcalculations.R.layout.layout21);
...
public void calculate(){
    ...
    //do the calculation
    Double calculatedValue = (11.43*value1);
